...
namespace QuantaQuirk\Notifications\Channels;
...
class MailChannel
{
     ...
     *
     * @var \QuantaQuirk\Contracts\Mail\Factory
     */
    protected $mailer;
     ...
     *
     * @param  \QuantaQuirk\Contracts\Mail\Factory  $mailer
     * @param  \QuantaQuirk\Mail\Markdown  $markdown
     * @return void
     */
     ...
     * @return \QuantaQuirk\Mail\SentMessage|null
     */
     ...
     * @param  mixed  $notifiable
     * @param  \QuantaQuirk\Notifications\Notification  $notification
     * @param  \QuantaQuirk\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
     ...
     *
     * @param  \QuantaQuirk\Notifications\Messages\MailMessage  $message
     * @return \QuantaQuirk\Mail\Markdown
     */
    ...
    protected function additionalMessageData($notification)
    {
        return [
            ...
            '__quantaquirk_notification_queued' => in_array(
                ShouldQueue::class,
     ...
     *
     * @param  \QuantaQuirk\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \QuantaQuirk\Notifications\Notification  $notification
     * @param  \QuantaQuirk\Notifications\Messages\MailMessage  $message
     * @return void
